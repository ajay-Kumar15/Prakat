...
public class Readdataexl {
	 public void writeExcel(String filePath,String fileName,String sheetName,String[] dataToWrite) throws IOException{
	    ...
	    Sheet sheet = (Sheet) guru99Workbook.getSheet("");
	    ...
	    Row newRow = ((org.apache.poi.ss.usermodel.Sheet) sheet).createRow(rowCount+1);
	    ...
	    public static void main(String...strings) throws IOException{
	        ...
	        Readdataexl objExcelFile = new Readdataexl();

	        //Write the file using file name, sheet name and the data to be filled

	        objExcelFile.writeExcel("C:\\Users\\Prakat-L-032\\Desktop\\","Records.xlsx","LoginDetails",valueToWrite);
